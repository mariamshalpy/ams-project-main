...
$errMsg="Update";
$getdata=mysqli_query($conn,"select FirstName,Email,Address,BirthDate,Password,PhoneNumber,JobTitle from `support` where FirstName='$userid'");
...
if(isset($_POST['Edit']))
{
    ...
    $jobtitle = $_POST['jobtitle'];
      ...
      //  $userid=$_SESSION['name'];
        $q="UPDATE `support` set FirstName='$name', Address='$address', PhoneNumber='$phonenumber', Password='$password',JobTitle='$jobtitle', BirthDate='$bdate',Email='$email' where FirstName='$userid' ";
