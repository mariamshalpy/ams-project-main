<?php 
  ...
  require '../../Model/alumni&student/itoop.php'; 
$errMsg="insert";
      ...
      <div class="row">
        <div class="col-lg-6  align-self-center">
          <div class="section-heading">
            ...
            <h2>"We apologize deeply to you for facing this problem. We will solve this problem as soon as possible."</h2>
        ...
        <option >itsupport3@gmail.com</option>
                ...
                <div class="col-lg-12">
                  <fieldset>
                    ...
                    <a style="color: #4c3d56;
    background-color: white;
    border-radius: 8px;
    size: 176px;" class="orange-button" href="itsupport1.php" >Reply</a>
