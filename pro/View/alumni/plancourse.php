...
require '../../Model/alumni&student/cour.php'; 
$errMsg="insert";
if(isset($_POST['send']))
{
          ...
          <div class="contact-us-content">
            ...
            <?php if($errMsg=="")
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <fieldset>
                  <input type="name" name="des" id="name" placeholder="Course Description..." autocomplete="on" required>
                  </fieldset>
                  <fieldset>
                  <input type="name" name="dur" id="name" placeholder="Course Duration..." autocomplete="on" required>
                  </fieldset>
