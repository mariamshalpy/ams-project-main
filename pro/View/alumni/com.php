...
require '../../Model/alumni&student/comm.php'; 
      ...
      <div class="row">
        <div class="col-lg-6  align-self-center">
          <div class="section-heading">
            <h6>COmmunicate</h6>
            <h2>“Communication is the solvent of all problems and is the foundation for personal development.”</h2>
        ...
        <div class="col-lg-6">
          <div class="contact-us-content">
            <form id="contact-form" action="" method="post">
              ...
              ?>
                  <fieldset>
                    <input type="name" name="emailfrom" id="emailfrom" placeholder="From..." autocomplete="on" required="">
                  </fieldset>
                </div>
                <div class="col-lg-12">
                  <fieldset>
                ...
                <div class="col-lg-12">
                  <fieldset>
                  <input type="text" name="message" id="message"  placeholder="Your text" required="">
			  ...
			  <option value="alumni">Alumni</option>
                ...
                <div class="col-lg-12">
                  <fieldset>
                    <button type="submit" id="form-submit" class="orange-button" name="send">Send</button>
                  </fieldset>
