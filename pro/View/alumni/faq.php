                    ...
                    <div class="accordion-item">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion_oneLeft" style="color:black"
                                                href="post-<?php echo $post['AdminId']; ?>" aria-expanded="false"
                                                class="collapsed">
                                                <?php echo $post["Questions"]; ?>
                                            </a>
                                        </h4>
                                    </div>
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body">
                                ...
                                <div id="post-<?php echo $post['AdminId']; ?>" aria-expanded="false" role="tablist">
                                    <div class="panel-body">
                                        <div class="text-accordion">
                                            <?php echo $post["Answers"]; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
