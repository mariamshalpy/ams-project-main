...
require '../../Model/alumni/donateoop.php'; 
  $errMsg="insert";
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li class="scroll-to-section"><a href="../../View/alumni/itsupport.php">TechnicalIssue</a></li>
                      <li class="scroll-to-section"><a href="../../View/alumni/facultynews.php">FacultyNews</a></li>
                      <li class="scroll-to-section"><a href="../../View/alumni/editprofile1.php">Editprofile</a></li>
  ...
  <div class="features">
    ...
    padding-left: 4px;">
          <a href="#contact">
            <div class="item">
              <div class="image">
                <img src="../../View/assets/images/student/money-withdraw-regular-24.png" alt="" style="max-width: 44px;">
              </div>
              <h4>Donation</h4>
            </div>
          </a>
