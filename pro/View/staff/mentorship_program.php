...
require_once "../../Model/staff/Mentorship.php";
require_once "../../Model/staff/Place.php";
require_once "../../Controller/staff/programHandler.php";
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="contact-us-content">
            ...
            <form id="contact-form" action="mentorship_program.php" method="post">
                      ...
                      <fieldset>
                       <div class="col-lg-12">
                        <select  class="form-select" name="type">
                                  ...
                                  <option>Type...</option>
                                  <option selected>Technical course</option>
                                  <option>Careerbuild</option>
                                </select>
                         </div>
                      </fieldset>
                 </div>
