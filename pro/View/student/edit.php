...
$errMsg="Update";
$getdata=mysqli_query($conn,"select FirstName,Email,Address,BirthDate,Password,PhoneNumber,JobTitle from `student` where FirstName='$userid'");
...
if(isset($_POST['Edit']))
{
    ...
    $jobtitle = $_POST['jobtitle'];
      ...
      //  $userid=$_SESSION['name'];
        $q="UPDATE `student` set FirstName='$name', Address='$address', PhoneNumber='$phonenumber', Password='$password',JobTitle='$jobtitle', BirthDate='$bdate',Email='$email' where FirstName='$userid' ";
