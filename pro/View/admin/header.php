...
<head>
  ...
  <link rel="stylesheet" href="../../View/assets/css/admin/admin.css">
...
<body>
      ...
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="#" onclick="window.history.back();" style="color: black;"><i class="fas fa-arrow-left"></i> Back</a>
  ...
  <div class="main-banner" id="top" style="padding : 42.6px ">
    <div class="container">
      <div class="row">
        <div class="col-lg-16">
