...
////////////////////////////////////////////////////////////////////////
    ...
    public function get_all_data(){
                    ...
                    echo "<td>";
                    echo '<button class="action-button"><a href="#" id="' . $event_post["ID"] . '" class="delete"><i class="fas fa-trash delete-icon"></i></a></button>';
                    echo "</td>";
                    echo "</tr>";
                  }
                }
              ...
              $('.delete').click(function(){
                   ...
                   {
                        window.location = "Events.php?delete=1&ID="+ID+"";
                   }
                   else
                   {
                        return false;
