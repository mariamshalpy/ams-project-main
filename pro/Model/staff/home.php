      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <a href="student/feedback.php">
            <div class="item">
              <div class="image">
                <img src="feedback.png" alt="" style="max-width: 44px;">
              </div>
              <h4>feed back</h4>
            </div>
          </a>
        ...
        <div class="col-lg-3 col-md-6 ">
          <a href="student/events.php">
            <div class="item">
              <div class="image">
                <img src="event.png" alt="" style="max-width: 44px;">
              </div>
              <h4>Events</h4>
            </div>
          </a>
        ...
        <div class="col-lg-3 col-md-6">
          <a href="student/events.php">
            <div class="item">
              <div class="image">
                <img src="faq.png" alt="" style="max-width: 44px;">
              </div>
              <h4>FAQ</h4>
            </div>
          </a>
        ...
        <div class="col-lg-3 col-md-6">
          <a href="student/news.php">
            <div class="item">
              <div class="image">
                <img src="newspaper-folded.png" alt="" style="max-width: 44px;">
              </div>
              <h4>NEws</h4>
            </div>
          </a>
