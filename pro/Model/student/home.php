    ...
    <div class="container">
      ...
      <div class="row gy-3 ">
        <div class=" col-lg-5 col-md-6 ">
            ...
            <div class="item">
              <div class="image">
                <img src="../../View/assets/images/student/profile.png" alt="" style="max-width: 44px;">
              </div>
              <h4>Profile Info</h4>
          </a>
          <br>
        ...
        <div class="card bg-glass">
          <div class="card-body px-4  px-md-5">
              ...
              <a href="./edit_profile.php" class="btn btn-primary btn-block mb-4" role="button">Edit Profile</a>
          ...
          <div class="col-lg-5 align-self-center">
            <div class="section-heading">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                labore
                et dolore magna aliqua. Quis ipsum suspendisse ultrices gravid risus commodo.</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="team-member">
              <div class="main-content">
                <img src="../../View/assets/images/main/member-01.jpg" alt="">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="team-member">
              <div class="main-content">
                <img src="../../View/assets/images/main/member-02.jpg" alt="">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="team-member">
              <div class="main-content">
                <img src="../../View/assets/images/main/member-03.jpg" alt="">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="team-member">
              <div class="main-content">
                <img src="../../View/assets/images/main/member-04.jpg" alt="">
        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="owl-carousel owl-testimonials">
              <div class="item">
                <p>“Please tell your friends or collegues about TemplateMo website. Anyone can access the website
                  to
                  download free templates. Thank you for visiting.”</p>
                <div class="author">
                  <img src="../../View/assets/images/main/testimonial-author.jpg" alt="">
                  <span class="category">Full Stack Master</span>
                  <h4>Claude David</h4>
                </div>
              </div>
              ...
              <div class="item">
                <p>“Scholar is free website template provided by TemplateMo for educational related websites. This
                  CSS layout is based on Bootstrap v5.3.0 framework.”</p>
                <div class="author">
                  <img src="../../View/assets/images/main/testimonial-author.jpg" alt="">
                  <span class="category">Digital Animator</span>
                  <h4>Stella Blair</h4>
          ...
          <div class="col-lg-12 col-md-6">
            <div class="item">
              <div class="row">
                <div class="col-lg-3">
                  <div class="image">
                    <img src="../../View/assets/images/main/event-01.jpg" alt="">
                  </div>
                </div>
                <div class="col-lg-9">
                  <ul>
          ...
          <div class="col-lg-12 col-md-6">
            <div class="item">
              <div class="row">
                <div class="col-lg-3">
                  <div class="image">
                    <img src="../../View/assets/images/main/event-02.jpg" alt="">
                  </div>
                </div>
                <div class="col-lg-9">
                  <ul>
          ...
          <div class="col-lg-12 col-md-6">
            <div class="item">
              <div class="row">
                <div class="col-lg-3">
                  <div class="image">
                    <img src="../../View/assets/images/main/event-03.jpg" alt="">
                  </div>
                </div>
                <div class="col-lg-9">
                  <ul>
