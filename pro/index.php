...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="../pro/View/assets/css/fontawesome.css">
    <link rel="stylesheet" href="../pro/View/assets/css/templatemo-scholar.css">
    <link rel="stylesheet" href="../pro/View/assets/css/owl.css">
    <link rel="stylesheet" href="../pro/View/assets/css/animate.css">
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                      ...
                      <li class="scroll-to-section"><a href="../pro/Controller/login.php">Sign in</a></li>
                      <li class="scroll-to-section"><a href="../pro/Controller/signup.php">Register</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <a href="./Model/student/feedback.php">
            <div class="item">
              <div class="image">
                <img src="../pro/View/assets/images/student/feedback.png" alt="" style="max-width: 44px;">
              </div>
              <h4>feed back</h4>
            </div>
          </a>
        ...
        <div class="col-lg-3 col-md-6 ">
          <a href="./Model/student/events.php">
            <div class="item">
              <div class="image">
                <img src="../pro/View/assets/images/student/event.png" alt="" style="max-width: 44px;">
              </div>
              <h4>Events</h4>
            </div>
          </a>
        ...
        <div class="col-lg-3 col-md-6">
          <a href="../pro/Model/student/faq.php">
            <div class="item">
              <div class="image">
                <img src="../pro/View/assets/images/student/faq.png" alt="" style="max-width: 44px;">
              </div>
              <h4>FAQ</h4>
            </div>
          </a>
        ...
        <div class="col-lg-3 col-md-6">
          <a href="./Model/student/news.php">
            <div class="item">
              <div class="image">
                <img src="../pro/View/assets/images/student/newspaper-folded.png" alt="" style="max-width: 44px;">
              </div>
              <h4>News</h4>
            </div>
          </a>
...
<!--        <div class="col-lg-3 col-md-6">
          <a href="student/survey.php">
            <div class="item">
              <div class="image">
                <img src="checklist.png" alt="" style="max-width: 44px;">
              </div>
              <h4>Survey</h4>
            </div>
          </a>
        ...
        <div class="col-lg-3 col-md-6">
          <a href="student/courses.php">
            <div class="item">
              <div class="image">
                <img src="online-course.png" alt="" style="max-width: 44px;">
              </div>
              <h4>Courses</h4>
            </div>
          </a>
        ...
        <div class="col-lg-3 col-md-6">
          <a href="student/com.php">
            <div class="item">
              <div class="image">
                <img src="chat.png" alt="" style="    max-width: 44px;">
              </div>
              <h4>Communication</h4>
            </div>
          </a>
...
-->
      ...
      <div class="row event_box">
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="../pro/View/assets/images/main/course-01.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6  development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="../pro/View/assets/images/main/course-02.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design wordpress">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="../pro/View/assets/images/main/course-03.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="../pro/View/assets/images/main/course-04.jpg" alt=""></a>
              <span class="category">Development</span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="../pro/View/assets/images/main/course-05.jpg" alt=""></a>
              <span class="category">Wordpress</span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="../pro/View/assets/images/main/course-06.jpg" alt=""></a>
              <span class="category">Webdesign</span>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="../pro/View/assets/images/main/member-01.jpg" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="../pro/View/assets/images/main/member-02.jpg" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="../pro/View/assets/images/main/member-03.jpg" alt="">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="team-member">
            <div class="main-content">
              <img src="../pro/View/assets/images/main/member-04.jpg" alt="">
        ...
        <div class="col-lg-7">
          <div class="owl-carousel owl-testimonials">
            <div class="item">
              ...
              <div class="author">
                <img src="../pro/View/assets/images/main/testimonial-author.jpg" alt="">
                <span class="category">Full Stack Master</span>
                <h4>Claude David</h4>
              </div>
            </div>
        ...
        <div class="col-lg-12 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-3">
                <div class="image">
                  <img src="../pro/View/assets/images/main/event-01.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-9">
                <ul>
        ...
        <div class="col-lg-12 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-3">
                <div class="image">
                  <img src="../pro/View/assets/images/main/event-02.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-9">
                <ul>
        ...
        <div class="col-lg-12 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-3">
                <div class="image">
                  <img src="../pro/View/assets/images/main/event-03.jpg" alt="">
                </div>
              </div>
              <div class="col-lg-9">
                <ul>
  ...
  <script src="../pro/View/vendor/jquery/jquery.min.js"></script>
  <script src="../pro/View/vendor/bootstrap/js/bootstrap.min.js"></script>
  <script src="../pro/View/assets/js/isotope.min.js"></script>
  <script src="../pro/View/assets/js/owl-carousel.js"></script>
  <script src="../pro/View/assets/js/counter.js"></script>
  <script src="../pro/View/assets/js/custom.js"></script>
